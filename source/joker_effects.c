...
const JokerInfo joker_registry[] = {
    { COMMON_JOKER,   2, default_joker_effect, NULL },  // DEFAULT_JOKER_ID = 0
    { COMMON_JOKER,   5, greedy_joker_effect, NULL },   // GREEDY_JOKER_ID  = 1
    { COMMON_JOKER,   5, lusty_joker_effect, NULL },    // etc...  2
    { COMMON_JOKER,   5, wrathful_joker_effect, NULL },         // 3
    { COMMON_JOKER,   5, gluttonous_joker_effect, NULL },       // 4
    { COMMON_JOKER,   3, jolly_joker_effect, NULL },            // 5
    { COMMON_JOKER,   4, zany_joker_effect, NULL },             // 6
    { COMMON_JOKER,   4, mad_joker_effect, NULL },              // 7
    { COMMON_JOKER,   4, crazy_joker_effect, NULL },            // 8
    { COMMON_JOKER,   4, droll_joker_effect, NULL },            // 9
    { COMMON_JOKER,   3, sly_joker_effect, NULL },              // 10
    { COMMON_JOKER,   4, wily_joker_effect, NULL },             // 11
    { COMMON_JOKER,   4, clever_joker_effect, NULL },           // 12
    { COMMON_JOKER,   4, devious_joker_effect, NULL },          // 13 
    { COMMON_JOKER,   4, crafty_joker_effect, NULL },           // 14
    { COMMON_JOKER,   5, half_joker_effect, NULL },             // 15
    { UNCOMMON_JOKER, 8, joker_stencil_effect, NULL },          // 16
    { COMMON_JOKER,   5, banner_joker_effect, NULL },           // 17
    { COMMON_JOKER,   4, walkie_talkie_joker_effect, NULL },    // 18
    { UNCOMMON_JOKER, 8, fibonnaci_joker_effect, NULL },        // 19
    { UNCOMMON_JOKER, 6, blackboard_joker_effect, NULL },       // 20
    { COMMON_JOKER,   5, mystic_summit_joker_effect, NULL },    // 21
    { COMMON_JOKER,   4, misprint_joker_effect, NULL },         // 22
    { COMMON_JOKER,   4, even_steven_joker_effect, NULL },      // 23
    { COMMON_JOKER,   5, blue_joker_effect, NULL },             // 24
    { COMMON_JOKER,   4, odd_todd_joker_effect, NULL },         // 25
    { COMMON_JOKER,   4, scholar_joker_effect, NULL },          // 26
    { COMMON_JOKER,   4, business_card_joker_effect, NULL },    // 27
    // Business card should be paired with Shortcut for palette optimization when it's added
    { COMMON_JOKER,   4, scary_face_joker_effect, NULL },       // 28
    { UNCOMMON_JOKER, 7, bootstraps_joker_effect, NULL},        // 29
    { UNCOMMON_JOKER, 5, NULL, NULL},                           // 30 Pareidolia
    { COMMON_JOKER,   6, reserved_parking_joker_effect, NULL }, // 31
    { COMMON_JOKER,   4, abstract_joker_effect, NULL },         // 32
    { UNCOMMON_JOKER, 6, bull_joker_effect, NULL},              // 33
    { RARE_JOKER,     8, the_duo_joker_effect, NULL},           // 34
    { RARE_JOKER,     8, the_trio_joker_effect, NULL},          // 35
    { RARE_JOKER,     8, the_family_joker_effect, NULL},        // 36
    { RARE_JOKER,     8, the_order_joker_effect, NULL},         // 37
    { RARE_JOKER,     8, the_tribe_joker_effect, NULL},         // 38
    { RARE_JOKER,     10, blueprint_joker_effect, NULL },       // 39
    { RARE_JOKER,     10, brainstorm_joker_effect, NULL },      // 40
    { COMMON_JOKER,   5, raised_fist_joker_effect, NULL },      // 41
    { COMMON_JOKER,   4, smiley_face_joker_effect, NULL },      // 42
    ...
    { UNCOMMON_JOKER, 6, acrobat_joker_effect, NULL },
    { COMMON_JOKER,   5, shoot_the_moon_joker_effect, NULL},
#endif
};
