...
#define FRAMES(x)            (((x) + _game_speed - 1) / _game_speed)
...
enum HandState
{
    HAND_DRAW,
    HAND_SELECT,
    // This is a misnomer because it's used for the deck, but it mechanically makes sense to be a state of the hand
    HAND_SHUFFLING,
    HAND_DISCARD,
    HAND_PLAY,
    HAND_PLAYING
